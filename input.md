...
For more information, see [Transfer Codings](https://datatracker.ietf.org/doc/html/rfc7230#section-4){: external} in *IETF RFC 7320 HTTP/1.1: Message Syntax and Routing*
