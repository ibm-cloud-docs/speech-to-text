...
-   *For next-generation models,* by setting the `interim_results` parameter to `true`. You can also set `low_latency` to `true` to enable both interim results and low latency together for the models. 
