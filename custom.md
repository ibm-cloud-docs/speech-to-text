...
> **Note:** Some languages do not support both language and acoustic customization. For more information, see [Language support for customization](#languageSupport).
