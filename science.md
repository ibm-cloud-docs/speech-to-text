...
{{site.data.keyword.IBM}} pioneered speech recognition and audio generation research and systems in the early 1960s. It continues this tradition with the {{site.data.keyword.speechtotextfull}} service. The following research and academic papers are especially relevant to the technical foundations of the service.
{: shortdesc}
