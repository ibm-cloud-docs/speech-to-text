...
The `character_insertion_bias` parameter is a functionality that is available for all next-generation models. The parameter is not available for previous-generation models.
